      ...
      <SectionWrapper>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <motion.div
            ...
            {/* FIX: prose-base for mobile, prose-lg for desktop. Added max-w-none to fill width. */}
            <div className="prose prose-base md:prose-lg max-w-none text-gray-600">
              {/* FIX: Adjusted header size and gap */}
              ...
              {/* FIX: Reduced left padding (pl-4) on mobile */}
              <div className="relative pl-4 md:pl-8 border-l-4 border-gray-100 mb-8">
                <Quote
                  // FIX: Smaller icon size and position adjustment for mobile
                  className="absolute -top-2 -left-2 md:-left-3 text-brand-yellow bg-white p-1"
                  size={28} // Reduced from 32 for better mobile fit
                  fill="currentColor"
                />
              ...
              <div className="mt-8 md:mt-12 pt-8 border-t border-gray-100 not-prose">
                ...
                {/* FIX: Added flex-wrap and adjusted gap/size for mobile */}
