...
import { getSingleTeamMember } from "@/services/team.service"; // Ensure casing matches your file
  ...
  if (!member) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-white">
        ...
        <Link
          href="/board-of-members" // Updated to match your folder structure
      ...
      <SectionWrapper>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <motion.div
            ...
            {/* Decorative Element behind (Desktop Only) */}
          ...
          <motion.div
            ...
            {/* RESPONSIVE PROSE FIX: 
                - prose-base on mobile (readable size)
                - prose-lg on desktop (larger size)
                - max-w-none (prevents arbitrary width capping)
            */}
            <div className="prose prose-base md:prose-lg max-w-none text-gray-600">
              ...
              <div className="mt-8 md:mt-12 pt-8 border-t border-gray-100 not-prose">
                <h3 className="text-xs md:text-sm font-bold text-gray-400 uppercase tracking-widest mb-6">
