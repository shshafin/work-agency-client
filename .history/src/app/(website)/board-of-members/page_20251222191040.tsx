...
const TeamCard = ({ member }: { member: ITeamMember }) => {
  return (
    <Link
      href={`/board-of-members/${member._id}`}
      className="block h-full">
      <motion.div
        variants={cardVariants}
        className="group relative h-112.5 w-full rounded-[2rem] overflow-hidden bg-gray-100 shadow-lg border border-gray-200 cursor-pointer">
...
export default function BoardPage() {
  ...
  return (
    <main className="bg-white min-h-screen pt-16 pb-24">
      {/* --- HERO HEADER --- */}
      <section className="text-center px-4 mb-7  relative z-10">
        <motion.div
