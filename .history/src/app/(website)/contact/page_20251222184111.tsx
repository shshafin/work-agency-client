...
export default function ContactPage() {
  ...
  return (
    <main className="bg-gray-50 min-h-screen relative overflow-hidden pt-32 pb-24">
      ...
      <div className="absolute -top-25 -right-25 w-[500px] h-125 bg-brand-red/5 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute top-50 left-[-100px] w-[300px] h-[300px] bg-brand-yellow/10 rounded-full blur-[100px] pointer-events-none" />
