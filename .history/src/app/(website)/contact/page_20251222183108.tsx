      ...
      <SectionWrapper className="py-0 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <motion.div
            ...
            <motion.div
              variants={itemVariants}
              className="relative h-72 w-full rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white group cursor-pointer">
              {/* Image */}
              <Image
              ...
              />
              {/* Dark Overlay */}
              <div className="absolute inset-0 bg-brand-red/20 mix-blend-multiply transition-opacity duration-500 group-hover:opacity-50" />

              {/* Pin Animation */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <span className="relative flex h-12 w-12">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-brand-red opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-12 w-12 bg-brand-red border-[3px] border-white shadow-xl items-center justify-center">
                    <MapPin
                      size={20}
                ...
                {/* Pulse Ring */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 border border-white/30 rounded-full animate-pulse opacity-50" />
              </div>
