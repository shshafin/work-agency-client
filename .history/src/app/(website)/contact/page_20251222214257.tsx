...
export default function ContactPage() {
  ...
  return (
    <main className="bg-gray-50 min-h-screen relative overflow-hidden pt-20 pb-24">
      {/* Background Decor */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <motion.div
            ...
            <ContactInfoCard
              ...
              lines={["Sat - Thu: 9:30 AM - 5:30 PM", "Friday: Closed"]}
              color="red"
            />

            {/* 4. HARDCODED MAP EMBED (As requested) */}
            <motion.div
              variants={itemVariants}
