...
import { createContact, CreateContactPayload } from "@/services/contact.service";
  ...
  >
    ...
    <div>
      ...
      {lines.map((line: string, i: number) => (
        <p key={i} className="text-gray-500 text-sm leading-relaxed font-medium">
          {line}
        </p>
      ))}
    </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            >
              {/* GOOGLE MAPS IFRAME */}
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d118147.68202069818!2d91.69204434151703!3d22.33588937989332!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30acd8a64095dfd3%3A0x5015cc5bcb6905d9!2sChattogram!5e0!3m2!1sen!2sbd!4v1700000000000!5m2!1sen!2sbd"
                width="100%"
                height="100%"
                style={{ border: 0 }}
              ...
              <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end pointer-events-none">
                <div className="bg-white/90 backdrop-blur-md px-4 py-2 rounded-xl shadow-lg border border-white/50">
                  ...
                  <p className="text-sm font-bold text-gray-900 flex items-center gap-1">
                    <Globe size={14} className="text-brand-red" /> Chattogram, BD
                  </p>
                </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-500 mb-8">
                We typically reply within <span className="text-brand-red font-bold">24 hours</span>.
              </p>
