  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <SectionWrapper className="pt-0 pb-12 md:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative h-100 md:h-150 w-full rounded-[2.5rem] overflow-hidden shadow-2xl bg-gray-100 border-8 border-white">
            <Image
      ...
      <div className="bg-neutral-950 py-24 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-100 h-100 bg-brand-yellow/5 rounded-full blur-[100px] pointer-events-none" />
        ...
        <SectionWrapper className="relative z-10">
          ...
          <div className="mt-16 text-center max-w-3xl mx-auto">
            <p className="text-gray-400 text-base md:text-lg italic">
              &quot;We combine creativity, comfort, and durability to make toys
              that children love and parents trust. With strict quality control
              and international safety standards, every toy is crafted to
              inspire learning, imagination, and endless joy.&quot;
            </p>
          </div>
        </SectionWrapper>
      </div>
