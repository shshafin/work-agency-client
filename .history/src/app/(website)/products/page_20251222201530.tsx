    ...
    <motion.div
      ...
      {product.isFeatured && (
        <div
          ...
          <div
            className="relative flex items-center justify-center rounded-full bg-linear-to-br from-yellow-300 via-yellow-500 to-yellow-600 shadow-[0_4px_15px_rgba(234,179,8,0.5)] border border-white/20 group-hover:scale-110 transition-transform duration-300 
            w-8 h-8 md:w-10 md:h-10" // Size classes
          >
            {/* Shine Effect */}
            <div className="absolute top-0 right-0 w-full h-full rounded-full bg-linear-to-t from-transparent to-white/20 pointer-events-none" />

            {/* Crown Icon with Responsive Size */}
            <Crown
              className="text-white drop-shadow-sm w-3.5 h-3.5 md:w-4.5 md:h-[18px]"
              fill="currentColor"
              strokeWidth={1.5}
            />
          </div>
