...
import {
  ...
  Eye,
  Heart,
  Crown, // Imported for the Premium Badge
} from "lucide-react";
      ...
      <section className="px-4 mb-12">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 bg-gray-50 p-4 rounded-[2rem] border border-gray-100 shadow-sm">
            ...
            {/* Category Tabs (Responsive: flex-wrap) */}
...
const ProductCard = ({ product, onClick }: ProductCardProps) => {
  return (
    <motion.div
      ...
      <div className="absolute bottom-4 right-4 flex flex-col gap-2 translate-y-20 group-hover:translate-y-0 transition-transform duration-300 opacity-0 group-hover:opacity-100 z-20">
      ...
      {/* Category Tag Only (Name Removed) */}
      ...
      {/* --- PREMIUM FEATURED BADGE (Gold Gradient + Crown) --- */}
      {product.isFeatured && (
        <div
          className="absolute top-4 left-4 z-20"
          title="Featured Product">
          <div className="relative flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-yellow-300 via-yellow-500 to-yellow-600 shadow-[0_4px_15px_rgba(234,179,8,0.5)] border border-white/20 group-hover:scale-110 transition-transform duration-300">
            {/* Shine Effect */}
