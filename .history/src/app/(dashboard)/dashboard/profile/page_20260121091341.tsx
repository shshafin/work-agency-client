...
const MyProfile = () => {
  ...
  // --- Role Check: Security ট্যাব শুধু Super Admin দেখবে ---
  const isSuperAdmin = user?.role === "super_admin";
  const tabs = isSuperAdmin ? ["general", "security"] : ["general"];

  // ট্যাব লিস্ট চেঞ্জ হলে অটোমেটিক 'general' এ ব্যাক করা যদি পারমিশন না থাকে
  useEffect(() => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm text-center">
            <div className="w-24 h-24 bg-brand-blue rounded-3xl flex items-center justify-center text-brand-yellow text-4xl font-black mx-auto mb-6 shadow-xl italic">
        ...
        <div className="lg:col-span-2">
          {activeTab === "general" ? (
            ...
            // Security Tab: Only rendered for Super Admin
            isSuperAdmin && (
              <div className="bg-white p-8 md:p-12 rounded-[2.5rem] border border-gray-100 shadow-sm">
                <div className="flex items-center gap-3 mb-10">
                  <Lock
