            ...
            <tbody className="divide-y divide-gray-50">
              {loading ? (
                ...
                messages.map((msg: any) => (
                  <tr
                    key={msg._id}
                    className={`hover:bg-gray-50/20 transition-colors ${msg.status === "new" ? "bg-brand-yellow/2" : ""}`}>
                    <td className="px-8 py-6 align-top">
                      <p className="font-bold text-brand-blue leading-none mb-1">
                        {msg.name}
                      </p>
                      <p className="text-[10px] text-gray-400 font-medium mb-2 truncate max-w-37.5">
                        {msg.email}
                      </p>
