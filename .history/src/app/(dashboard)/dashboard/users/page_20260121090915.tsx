...
const UsersList = () => {
  ...
  const fetchUsers = useCallback(async () => {
    ...
    try {
      ...
      // নিজের প্রোফাইল বাদে বাকিদের দেখানো
  ...
  // --- Block/Unblock Logic (Status Toggle) ---
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
          <div className="relative flex-1 md:w-64">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-white border border-gray-100 rounded-2xl text-sm focus:ring-2 focus:ring-brand-yellow outline-none transition-all shadow-sm"
                  ...
                  <tr
                    ...
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-xl bg-brand-blue text-brand-yellow flex items-center justify-center font-black shadow-inner">
                          {u.name.charAt(0)}
                        </div>
                        <div>
                    ...
                    <td className="px-8 py-6">
                      <span className="text-[9px] font-black uppercase tracking-widest px-3 py-1 bg-gray-100 rounded-lg text-brand-blue">
                        {u.role.replace("_", " ")}
                      </span>
                    </td>
                    <td className="px-8 py-6">
        ...
        <div className="px-8 py-5 bg-gray-50/50 border-t border-gray-100 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="p-2.5 bg-white border border-gray-200 rounded-xl hover:border-brand-yellow disabled:opacity-20 transition-all">
              <ChevronLeft size={20} />
            </button>
            <button
      ...
      {deleteId && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-brand-blue/40 backdrop-blur-md animate-in fade-in duration-300">
          <div className="bg-white w-full max-w-sm rounded-[3rem] p-10 shadow-2xl text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm font-medium mt-2 leading-relaxed">
                Are you absolutely sure you want to remove this user? This
            ...
            <div className="flex gap-3 pt-2">
              <button
                ...
                className="flex-1 py-4 bg-gray-100 text-gray-500 font-black rounded-2xl hover:bg-gray-200 transition-all uppercase text-xs tracking-widest">
                Cancel
              </button>
              <button
                onClick={confirmDelete}
                className="flex-1 py-4 bg-red-500 text-white font-black rounded-2xl hover:bg-red-600 transition-all shadow-lg shadow-red-500/20 uppercase text-xs tracking-widest">
                Confirm
              </button>
            </div>
          </div>
