            ...
            <div className="bg-brand-blue p-10 rounded-[3rem] md:rounded-[4rem] text-white shadow-2xl shadow-brand-blue/20 lg:sticky lg:top-32 border border-white/5">
              ...
              <div className="space-y-4">
                <Link
                  ...
                  className="w-full py-6 bg-brand-yellow text-brand-blue font-black rounded-4xl flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-95 transition-all uppercase tracking-widest text-sm shadow-xl shadow-brand-yellow/10">
                  <button>
