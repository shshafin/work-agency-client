        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {job.requirements.map((req: string, i: number) => (
                      <div
                        key={i}
                        className="flex items-start gap-4 p-5 bg-gray-50 rounded-4xl">
                        <CheckCircle2
                          size={22}
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-brand-blue p-10 rounded-[4rem] text-white shadow-2xl shadow-brand-blue/20 sticky top-32">
              ...
              <button className="w-full py-6 bg-brand-yellow text-brand-blue font-black rounded-4xl flex items-center justify-center gap-3 hover:scale-[1.02] transition-all uppercase tracking-widest text-sm mb-4">
                Apply Now <ArrowRight size={20} />
              </button>

              <button className="w-full py-4 border-2 border-white/10 text-white font-black rounded-4xl flex items-center justify-center gap-3 hover:bg-white hover:text-brand-blue transition-all uppercase tracking-widest text-xs">
