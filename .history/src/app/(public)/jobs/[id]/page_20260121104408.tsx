        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-brand-blue p-10 rounded-[3rem] md:rounded-[4rem] text-white shadow-2xl shadow-brand-blue/20 lg:sticky lg:top-32 border border-white/5">
              <h3 className="text-3xl font-black italic uppercase text-brand-yellow tracking-tighter mb-6 leading-none">
                Apply Now
              </h3>
              ...
              <div className="space-y-4">
                <button className="w-full py-6 bg-brand-yellow text-brand-blue font-black rounded-[2rem] flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-95 transition-all uppercase tracking-widest text-sm shadow-xl shadow-brand-yellow/10">
                  Submit Application <ArrowRight size={20} />
                </button>

                <button
                  onClick={handleShare}
                  className="w-full py-4 border-2 border-white/10 text-white font-black rounded-[2rem] flex items-center justify-center gap-3 hover:bg-white hover:text-brand-blue hover:border-white transition-all uppercase tracking-widest text-xs">
