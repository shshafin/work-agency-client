    ...
    <main className="pt-32 pb-20 bg-brand-light relative overflow-hidden min-h-screen">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-[0.02] [mask-image:radial-gradient(ellipse_at_center,black,transparent)]" 
             style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 30L30 0M30 30L60 30M30 30L30 60M30 30L0 30' stroke='%230A2647' stroke-width='1' fill='none'/%3E%3C/svg%3E")` }} />
      </div>
          ...
          <div className="w-full lg:w-5/12 space-y-12">
            <div className="space-y-6">
              ...
              >
                ...
                <span className="text-[10px] font-mono font-bold text-slate-500 uppercase tracking-[0.3em]">Communication Hub</span>
              </motion.div>
              ...
              <p className="text-slate-500 text-lg font-medium max-w-sm leading-relaxed border-l-4 border-brand-blue pl-6">
                Connect with Portugal&apos;s premier talent architects. We’re ready to scale your industrial vision.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4">
              {[
                { icon: <Mail size={20}/>, label: "Digital Mail", val: "contact@er-ett.com", color: "hover:border-blue-400" },
                { icon: <Phone size={20}/>, label: "Direct Line", val: "+351 920 019 186", color: "hover:border-orange-400" },
                { icon: <MapPin size={20}/>, label: "HQ Location", val: "Sintra, Lisbon, Portugal", color: "hover:border-emerald-400" },
              ].map((item, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <div>
                    <span className="text-[9px] font-mono font-black text-slate-400 uppercase tracking-widest block mb-0.5">{item.label}</span>
                    <span className="text-base font-bold text-brand-blue">{item.val}</span>
                  </div>
                </motion.div>
              ))}
            </div>
              ...
              <AnimatePresence mode="wait">
                {isSuccess ? (
                  ...
                  >
                    ...
                    <div>
                      <h2 className="text-4xl font-black text-brand-blue mb-2">Transmission Successful.</h2>
                      <p className="text-slate-500 font-medium">Our strategic team will respond within 24 operational hours.</p>
                    </div>
                    <button 
                    ...
                    <form onSubmit={methods.handleSubmit(onSubmit)} className="space-y-8 relative z-10">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="group/input">
                          <FormInput name="name" label="Identifying Name" placeholder="Full name" />
                        </div>
                        <div className="group/input">
                          <FormInput name="email" label="Digital Address" type="email" placeholder="email@domain.com" />
                        </div>
                      </div>
                      
                      <FormInput name="subject" label="Inquiry Intent" placeholder="Brief subject" />
                      ...
                      >
                        ...
                        <div className="absolute inset-0 bg-brand-yellow translate-x-[-100%] group-hover/btn:translate-x-0 transition-transform duration-500" />
                      </button>

                      {/* Professional Legal Footer */}
                      <p className="text-[9px] text-slate-300 text-center font-bold uppercase tracking-widest pt-4">
                        Secure Transmission &bull; GDPR Compliant &bull; End-to-End Professional Privacy
                      </p>
                    </form>
                  </FormProvider>
                )}
