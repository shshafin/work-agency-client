...
const ContactPage = () => {
  ...
  return (
    <main className="pt-24 pb-16 bg-[#fcfcfc] min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-125 bg-brand-yellow/5 rounded-full blur-[100px] -z-10 animate-pulse" />
      <div className="absolute bottom-0 left-0 w-125 h-125 bg-brand-blue/5 rounded-full blur-[100px] -z-10" />
