...
import GSLCheckbox from "@/components/core/GSLForm/GSLCheckbox"; // Assuming you have a GSLCheckbox component
...
const formSchema = z.object({
  ...
  isPublished: z.boolean().default(false), // 🆕 Checkbox
...
export default function EditBlogPage({
      ...
      try {
        ...
        if (res.success) {
          ...
          form.reset({
            ...
            coverImage: data.coverImage, // Existing image URL for preview
          });
        }
      } catch (error) {
  ...
  const onSubmit = async (values: any) => {
    ...
    try {
      ...
      // 2. File (Key must be 'coverImage' based on backend, only if it's a new file)
        ...
        <CardContent>
          <GSLForm
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              />
              {/* Assuming you have a GSLCheckbox component */}
