...
import GSLRichTextEditor from "@/components/core/GSLForm/GSLRichTextEditor"; // 🆕 Rich Text Editor
  ...
  const onSubmit = async (values: any) => {
    ...
    try {
      ...
      const blogData = {
        ...
        isPublished: true, // You might want a checkbox for draft mode later
      };
