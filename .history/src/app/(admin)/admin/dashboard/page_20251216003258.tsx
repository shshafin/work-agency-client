    ...
    <div className="space-y-6">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            A log of key actions performed by admins.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className="bg-white rounded-lg border p-8 text-center mt-8 shadow-inner">
        ...
        <p className="text-gray-500 max-w-lg mx-auto mt-2">
          Select a module from the sidebar to manage your website content. Your
          dashboard provides real-time stats and system logs for monitoring.
        </p>
      </div>
    </div>
  );
