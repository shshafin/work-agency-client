                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div className="relative">
                    <GSLInput
                      ...
                      className="pl-10"
                    />
                    {/* Absolute container centered over the input field */}
                    <div className="absolute left-0 bottom-0 h-10 w-10 flex items-center justify-center pointer-events-none text-gray-400">
