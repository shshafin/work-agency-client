    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex items-center gap-2">
            ...
            <DialogContent>
              ...
              <div className="grid gap-4 py-4">
                <div className="relative h-64 w-full rounded-lg overflow-hidden border">
                  {row.original.images?.[0] && <Image src={row.original.images[0]} alt="Product" fill className="object-cover" />}
                </div>
          ...
          <Button 
            variant="ghost" size="icon" className="h-8 w-8 text-gray-500 hover:text-red-600 hover:bg-red-50"
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete <b>{products.find(p => p._id === deleteId)?.name}</b>.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
