...
export default function MessagesPage() {
  ...
  const itemsPerPage = 10; // Adjust if you want 5 or 20
              ...
              {viewMessage && (
                <div className="space-y-6 py-4">
                  ...
                  <div>
                    ...
                    <div className="p-4 bg-white border rounded-md shadow-sm min-h-37.5 text-gray-700 whitespace-pre-wrap leading-relaxed">
                      {viewMessage.message}
                    </div>
                  </div>
                </div>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-gray-500 text-sm sm:text-base">
              Read inquiries from your website
            </p>
          </div>

          <div className="w-full sm:w-auto bg-gray-100 px-4 py-2 rounded-full text-sm font-medium text-center sm:text-left">
