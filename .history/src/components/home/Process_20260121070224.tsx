          ...
          {steps.map((step, index) => (
            <motion.div
              ...
              <div className="h-full bg-white border border-slate-100 p-8 rounded-[2rem] shadow-[0_10px_30px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_50px_-20px_rgba(0,0,0,0.1)] transition-all duration-500 relative overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-full h-[2px] bg-linear-to-r from-transparent via-blue-400 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
              </div>
            </motion.div>
          ))}
        </div>
