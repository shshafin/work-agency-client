        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-blue-100/60 text-lg leading-relaxed max-w-xl">
              Since 2019, Work Supply has bridged the gap between labor
              shortages and professional excellence. Our footprint across Europe
              ensures that no matter where you are, quality manpower is just a
              call away.
            </p>
