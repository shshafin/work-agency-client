              ...
              {stats.map((stat, index) => (
                <div
                  ...
                  <div className="absolute left-0 lg:left-1/2 lg:-translate-x-1/2 z-30">
                    <div
                      className="w-[48px] h-[48px] flex items-center justify-center rounded-xl bg-white shadow-md border"
                      style={{
                    ...
                    <div className="absolute top-1/2 -translate-y-1/2 left-[23px] lg:left-1/2 lg:-translate-x-1/2 w-2 h-2 rounded-full bg-brand-blue border-2 border-white z-40" />
                  </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white border border-brand-blue/5 shadow-xl shadow-brand-blue/[0.02] p-1">
            ...
            <div className="absolute bottom-0 left-0 h-[2px] w-full bg-slate-100">
              <motion.div
                ...
                className="absolute h-full w-1/3 bg-gradient-to-r from-transparent via-brand-yellow to-transparent"
              />
            </div>
          </div>
        </motion.div>
