      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-start">
          ...
          <div className="w-full lg:w-1/2 lg:sticky lg:top-32">
            ...
            <div className="relative h-75 w-full hidden lg:block">
          ...
          <div className="w-full lg:w-1/2 space-y-4">
            ...
            <motion.div
              ...
              <button
                ...
                className="w-full p-6 md:p-8 bg-brand-yellow rounded-[1.5rem] md:rounded-[2rem]
        flex items-center justify-between group overflow-hidden relative
        shadow-lg shadow-brand-yellow/10">
                ...
                <div className="absolute top-0 right-0 w-24 md:w-32 h-full bg-white/10 skew-x-30 translate-x-10" />
              </button>
            </motion.div>
          </div>
        </div>
