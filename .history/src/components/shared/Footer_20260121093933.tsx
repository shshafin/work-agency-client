          ...
          <motion.div
            ...
            <form
              ...
              <input
                ...
                disabled={loading}
                className="w-full bg-gray-800/50 border border-gray-700 rounded-full py-4 px-6 text-sm focus:outline-none focus:border-brand-yellow transition-all text-white disabled:opacity-50"
              />
              <button
                disabled={loading}
                type="submit"
                className="absolute right-2 top-2 bottom-2 bg-brand-yellow text-brand-dark px-4 rounded-full hover:bg-white transition-all flex items-center justify-center min-w-[50px]">
                {loading ? (
                  <Loader2
                    size={18}
