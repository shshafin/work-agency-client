      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <motion.div
            ...
            <h3 className="text-lg font-bold mb-6 border-l-4 border-brand-yellow pl-3">
              Explore
            </h3>
          ...
          <motion.div
            ...
            <h3 className="text-lg font-bold mb-6 border-l-4 text-gray-300 border-brand-yellow pl-3">
              Main Sectors
            </h3>
            <ul className="space-y-4">
          ...
          <motion.div
            ...
            className="space-y-6">
            <h3 className="text-lg font-bold border-l-4 border-brand-yellow pl-3">
              Newsletter
            </h3>
