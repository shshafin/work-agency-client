...
const DepartmentsSection = () => {
  ...
  return (
    ...
    <SectionWrapper className="relative overflow-hidden bg-gradient-to-b from-[#B91C1C] to-[#450a0a]">
      ...
      <div className="text-center mb-16 max-w-3xl mx-auto relative z-10">
        ...
        <p className="text-red-100 mt-2 text-lg font-light">
            ...
            >
              ...
              <div
                className={cn(
                  ...
                  isActive
                    ? "bg-gradient-to-br from-brand-yellow/20 to-brand-red/40 border-brand-yellow/50 shadow-[0_0_40px_rgba(255,215,0,0.3)] scale-105 z-10"
                ...
                <div className="absolute bottom-0 left-0 w-full h-1 bg-white/10">
                  <div
                    className={cn(
                      "h-full bg-brand-yellow transition-all duration-[2000ms] ease-linear",
                      isActive ? "w-full" : "w-0"
                    )}
                  />
                </div>
