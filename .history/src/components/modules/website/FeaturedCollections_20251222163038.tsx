      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-auto lg:h-[650px]">
        ...
        <TiltCard
          ...
          <div className="relative h-full w-full">
            {/* NEW WORKING IMAGE */}
            <Image
              src="https://images.unsplash.com/photo-1581557991964-125469da3b8a?q=80&w=1000&auto=format&fit=crop"
              alt="Soft Toys"
              fill
              className="object-cover transition-transform duration-700 group-hover:scale-110"
            />
            {/* OVERLAY: Reduced opacity to 50% default */}
          ...
          <TiltCard
            ...
            <div className="relative h-full w-full">
              <Image
                ...
                className="object-cover transition-transform duration-700 group-hover:scale-110"
              />
              {/* OVERLAY: Reduced opacity to 40% default */}
