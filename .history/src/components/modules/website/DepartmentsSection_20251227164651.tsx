...
const DepartmentsSection = () => {
  ...
  const CYCLE_DURATION = 4000; // 4 Seconds per card
        ...
        {departments.map((dept, index) => {
          ...
          return (
            <div
              ...
              <div
                className={cn(
                  "relative h-full p-8 rounded-2xl transition-all border overflow-hidden",
                  isActive
                ...
                style={{
                  transitionDuration: `${isActive ? "4000ms" : "1500ms"}`,
                }}>
                {/* 1. FLASH EFFECT */}
                <div
                  className={cn(
                    "absolute inset-0 bg-linear-to-r from-transparent via-white/20 to-transparent skew-x-12 transition-transform",
                    isActive ? "translate-x-full" : "-translate-x-full"
                  )}
                  style={{ transitionDuration: isActive ? "1500ms" : "0ms" }}
                />
