      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:items-center">
        ...
        <div className="lg:w-1/3 z-10">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            {/* 1. MAJOR COUNTRIES: RED GRADIENT (White Text) */}
            <div className="p-4 md:p-6 rounded-2xl bg-gradient-to-br from-brand-red to-red-700 text-white shadow-lg shadow-brand-red/20 transform hover:-translate-y-1 transition-transform duration-300">
              ...
              <p className="text-xs text-white/80 uppercase tracking-wider font-bold mt-1">
                Major Countries
              </p>
            </div>

            {/* 2. EXPORT ORIENTED: YELLOW GRADIENT (Black Text) */}
            <div className="p-4 md:p-6 rounded-2xl bg-gradient-to-br from-brand-yellow to-yellow-400 text-black shadow-lg shadow-brand-yellow/20 transform hover:-translate-y-1 transition-transform duration-300">
              ...
              <p className="text-xs text-black/70 uppercase tracking-wider font-bold mt-1">
                Export Oriented
              </p>
            </div>
          </div>
