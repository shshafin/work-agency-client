    ...
    <div className="min-h-20 md:min-h-22.5 lg:min-h-17.5 flex items-center flex-wrap">
      <AnimatePresence mode="wait">
        <motion.h2
          ...
          className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight wrap-break-word"
          variants={container}
          initial="hidden"
          animate="visible"
          exit="exit">
  ...
  return (
    <SectionWrapper className="relative bg-neutral-950 overflow-hidden py-16 md:py-20 lg:py-24">
      {/* =========================================
          BACKGROUND EFFECTS
      ========================================= */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full bg-[radial-gradient(circle_at_center,var(--tw-gradient-stops))] from-brand-red/10 via-neutral-950 to-neutral-950 pointer-events-none" />
      <div
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        */}
        ...
        <div
          ref={containerRef}
          className="relative w-full aspect-video md:aspect-21/9 rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden group cursor-pointer shadow-2xl shadow-brand-red/10 border border-white/10"
          onClick={handlePlay}>
          {/* IMAGE */}
          <div className="absolute inset-0 overflow-hidden">
            <motion.div
              ...
              <Image
                ...
                fill
                className="object-cover transition-transform duration-1500 group-hover:scale-105 filter grayscale-20 group-hover:grayscale-0"
              />
            </motion.div>
          </div>
