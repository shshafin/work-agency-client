...
const FeaturedCollections = () => {
  return (
    <SectionWrapper className="bg-white overflow-hidden relative">
      ...
      {/* --- BENTO GRID (FIXED MD RESPONSIVENESS) --- */}
      {/* Use grid-cols-1 for mobile, md:grid-cols-2 for tablet, and lg:grid-cols-3 for desktop */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 h-auto lg:h-162.5 px-4 md:px-0">
        {/* 1. SOFT TOYS (Left Side) */}
        <TiltCard
        ...
        {/* RIGHT SIDE CONTAINER (Houses the other 3 parts) */}
        <div className="md:col-span-1 lg:col-span-2 flex flex-col gap-6 h-full">
          {/* 2. PLASTIC TOYS (Wide Top Card) */}
          <TiltCard
          ...
          {/* BOTTOM SPLIT (Accessories and Others) */}
