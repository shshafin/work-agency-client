...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "hidden lg:flex w-full h-10 bg-gradient-to-r from-brand-red to-red-900 text-white text-[11px] items-center justify-between px-8 z-50 relative transition-all duration-300",
      ...
      <motion.header
        ...
        <div className="container mx-auto flex items-center justify-between px-4 lg:px-8">
          ...
          <div className="hidden lg:flex items-center shrink-0">
            <Link href="/contact">
              <PoshButton
                className="shadow-lg h-10 px-6 text-[11px] font-black uppercase tracking-[0.1em]
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="fixed inset-0 top-[60px] md:top-[72px] w-full bg-white z-[60] lg:hidden overflow-y-auto">
