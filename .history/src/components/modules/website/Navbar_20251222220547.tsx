...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "hidden xl:flex w-full h-10 bg-gradient-to-r from-brand-red to-red-900 text-white text-[11px] items-center justify-between px-8 z-[51] relative transition-all duration-300",
      ...
      <motion.header
        ...
        <div className="container mx-auto flex items-center justify-between px-4 lg:px-8">
          ...
          <div className="hidden xl:flex items-center shrink-0">
            <Link href="/contact">
              <PoshButton className="shadow-lg h-11 px-6 text-[11px] font-black uppercase tracking-widest bg-gradient-to-r from-brand-red to-red-800 text-white hover:shadow-red-500/20 active:scale-95">
                Get Quote
              </PoshButton>
            </Link>
          </div>
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 h-full w-[85%] sm:w-[400px] bg-white z-[70] shadow-2xl xl:hidden flex flex-col">
              {/* Drawer Header */}
              ...
              <div className="p-6 bg-gray-50 space-y-6">
                ...
                <Link
                  ...
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="block">
                  <button className="w-full py-4 bg-gradient-to-r from-brand-red to-red-800 text-white rounded-xl font-black uppercase tracking-widest text-sm shadow-xl shadow-red-900/10 active:scale-[0.98] transition-all">
                    Get A Quote
                  </button>
                </Link>
              </div>
