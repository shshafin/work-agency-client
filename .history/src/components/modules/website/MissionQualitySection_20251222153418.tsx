        ...
        {features.map((feature, index) => (
          <motion.div
            ...
            <div className="relative h-full bg-white p-8 rounded-[2rem] shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border-t-4 border-brand-red">
              ...
              {/* LAYER 1: Hover Red Gradient (Now z-0 so it doesn't cover layer 2) */}
              ...
              {/* LAYER 2: WATERMARK ICON (Now z-10 so it sits ON TOP of the red bg) */}
              {/* Added opacity-20 for hover to make it clearly visible against red */}
              <feature.icon
              ...
              {/* LAYER 3: CONTENT (z-20 to sit on top of everything) */}
