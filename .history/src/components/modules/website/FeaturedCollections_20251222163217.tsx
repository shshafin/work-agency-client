      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-auto lg:h-[650px]">
        ...
        <TiltCard
          ...
          <div className="relative h-full w-full">
            {/* NEW IMAGE: Fabric/Cotton Stitched Toys (Bunnies/Dolls) */}
            <Image
              src="https://images.unsplash.com/photo-1582234057912-280456157303?q=80&w=1000&auto=format&fit=crop"
              alt="Soft Cloth Toys"
              fill
            ...
            <div
              ...
              <p className="text-white/90 text-sm mb-4">
                Cotton, fabric & plush stuffed toys.
              </p>
