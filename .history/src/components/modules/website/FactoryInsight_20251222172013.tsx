...
const TypewriterTitle = ({ text }: { text: string }) => {
  ...
  return (
    <div className="min-h-[80px] md:min-h-[90px] lg:min-h-[70px] flex items-center flex-wrap">
      <AnimatePresence mode="wait">
        <motion.h2
          ...
          className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight break-words"
          variants={container}
          initial="hidden"
          animate="visible"
          exit="exit">
