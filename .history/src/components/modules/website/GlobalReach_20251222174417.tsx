      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:items-center">
        ...
        <div className="lg:w-1/3 z-10">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            <div className="p-4 md:p-6 rounded-2xl bg-gradient-to-br from-red-400 to-brand-red text-white shadow-lg shadow-brand-red/20 transform hover:-translate-y-1 transition-transform duration-300">
            ...
            <div className="p-4 md:p-6 rounded-2xl bg-gradient-to-br from-yellow-300 to-brand-yellow text-black shadow-lg shadow-brand-yellow/20 transform hover:-translate-y-1 transition-transform duration-300">
        ...
        {/* RIGHT CONTENT: MAP */}
        <div className="lg:w-2/3 relative h-[450px] md:h-137.5 w-full bg-slate-50 rounded-3xl border border-gray-200 overflow-hidden shadow-inner group/map">
          {/* MAP IMAGE */}
