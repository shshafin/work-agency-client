  ...
  return (
    <div className="min-h-15 flex justify-center items-center px-4">
      <AnimatePresence mode="wait">
        <motion.h2
          key={key}
          className="text-3xl md:text-5xl font-bold text-brand-red mb-4 drop-shadow-sm flex flex-wrap justify-center gap-x-3"
          variants={container}
          initial="hidden"
          animate="visible"
          exit="exit">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 h-auto lg:h-162.5 px-4 md:px-0">
        ...
        <TiltCard
          ...
          <div className="relative h-full w-full">
            <Image
              src="https://i.ibb.co.com/vxDX5Wtx/Screenshot-261.png?q=80&w=1000"
              alt="Soft Toy"
              fill
            ...
            <div
              ...
              <h3 className="text-4xl font-bold text-white mb-2">Soft Toy</h3>
              <p className="text-white/90 text-sm mb-4">
                Cotton, fabric & plush toys.
              </p>
              <span className="inline-flex items-center text-brand-yellow font-bold text-sm uppercase group-hover:underline">
        ...
        <div className="md:col-span-1 lg:col-span-2 flex flex-col gap-6 h-full">
          {/* 2. PLASTIC TOYS */}
          <TiltCard
            href="/products?category=Plastic Toy"
            ...
            <div className="relative h-full w-full">
              <Image
                ...
                className="object-cover transition-transform duration-700 group-hover:scale-110"
              />
              <div className="absolute inset-0 bg-linear-to-r from-brand-red/90 via-transparent to-transparent opacity-40 group-hover:opacity-90 transition-opacity duration-500" />
              <div
                className="absolute bottom-0 left-0 p-8 w-full"
                ...
                <div className="flex justify-between items-end">
                  ...
                  <div className="w-12 h-12 rounded-full bg-brand-yellow flex items-center justify-center text-brand-red shadow-lg">
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <TiltCard
              ...
              <div className="relative h-full w-full">
                <Image
                  src="https://images.unsplash.com/photo-1532330393533-443990a51d10"
                  alt="Others"
                  fill
                  className="object-cover transition-transform duration-700 group-hover:scale-110"
                />
