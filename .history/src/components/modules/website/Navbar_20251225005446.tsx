...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "hidden xl:flex w-full h-10 bg-linear-to-r bg-[#bedae5] text-brand-red text-[11px] items-center justify-between px-8 z-51 relative transition-all duration-300",
