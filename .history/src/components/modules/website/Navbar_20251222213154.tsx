...
import { getSiteSettings } from "@/services/SiteSettingService"; // Adjust path as needed
...
const Navbar = () => {
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        // Assuming the data is in response.data based on your service
  ...
  // Default values to show while loading or if data is missing
  const siteInfo = {
      ...
      <div className="hidden md:flex w-full h-10 bg-linear-to-r from-brand-red to-red-900 text-white text-xs items-center justify-between px-4 md:px-8 z-50 relative">
        <div className="flex items-center gap-6">
          ...
          <a
            ...
            className="flex items-center gap-2 hover:text-brand-yellow transition-colors cursor-pointer">
            <Mail
              size={14}
      ...
      <motion.header
        ...
        <div className="container mx-auto flex items-center justify-between px-4 md:px-6">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link href="/contact">
              <PoshButton
                className="shadow-none border-none h-9 px-6 text-xs uppercase tracking-widest
            ...
            <motion.div
              ...
              <div className="flex flex-col p-6 space-y-4">
                ...
                <div className="pt-4 border-t">
                  ...
                  <a
                    href={`tel:${siteInfo.phone}`}
                    className="text-brand-red font-black text-xl">
                    {siteInfo.phone}
                  </a>
