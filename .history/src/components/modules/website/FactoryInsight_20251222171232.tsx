...
// --- REUSABLE TYPEWRITER COMPONENT (Continuous Loop) ---
const TypewriterTitle = ({ text }: { text: string }) => {
  ...
  return (
    <div className="min-h-[50px] md:min-h-[70px] flex items-center">
        ...
        <motion.h2
          ...
          {letters.map((letter, index) => (
            <motion.span
              variants={child}
              key={index}
              className={index > 10 ? "text-brand-red" : "text-white"} // First part White, second part Red
            >
              {letter === " " ? "\u00A0" : letter}
            </motion.span>
          ))}
...
const FactoryInsight = () => {
  ...
  return (
    <SectionWrapper className="relative bg-neutral-950 overflow-hidden py-24">
      {/* =========================================
          1. BACKGROUND EFFECTS (Watermarks)
      ========================================= */}
      ...
      {/* Layer 2: Technical Grid Pattern (The Watermark) */}
      <div
      ...
      {/* Layer 3: Floating Particles (Optional subtle movement) */}
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div>
            ...
            {/* "Inside The Powerhouse" -> Powerhouse will turn Red automatically */}
            <TypewriterTitle text="Inside The Powerhouse" />
          </div>

          {/* UPDATED CONTENT (No 50k sq ft) */}
        ...
        <div
          ...
          {/* CENTER PLAY BUTTON WITH ROTATING TEXT */}
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative w-24 h-24 md:w-32 md:h-32 flex items-center justify-center">
              ...
              {/* Center Icon */}
              <div className="w-12 h-12 md:w-16 md:h-16 bg-brand-yellow rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(255,215,0,0.4)] group-hover:scale-110 transition-transform duration-300">
                <Play
                  size={24}
          ...
          {/* BOTTOM INFO */}
          <div className="absolute bottom-0 left-0 w-full p-8 bg-gradient-to-t from-black/90 to-transparent flex justify-between items-end transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
            <div>
