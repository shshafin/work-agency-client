      ...
      <motion.header
        ...
        <div className="container mx-auto flex items-center justify-between px-4 md:px-6">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link href="/contact">
              {/* 🔴 FIXED: Added bg-brand-red to force the RED color */}
              <PoshButton className="shadow-none bg-brand-red hover:bg-red-700 text-white shadow-brand-red/30 border-none">
                Get Quote
              </PoshButton>
            </Link>
          </div>
