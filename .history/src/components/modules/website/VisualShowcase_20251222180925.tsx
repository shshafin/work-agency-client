...
// --- HEADER COMPONENT (RESPONSIVE FIX) ---
      ...
      <AnimatePresence mode="wait">
        <motion.h2
          ...
          {words.map((word, wordIndex) => (
            // Wrap words in a span so they stay together
            <span
              key={wordIndex}
...
const InfiniteRow = ({
  ...
  return (
    <div className="relative w-full overflow-hidden group/row">
      ...
      <div className="absolute top-0 right-0 h-full w-12 bg-linear-to-l from-white to-transparent z-10 pointer-events-none" />
