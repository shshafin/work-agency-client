      ...
      <motion.header
        ...
        <div className="container mx-auto flex items-center justify-between px-4 lg:px-8">
          ...
          <div className="hidden xl:flex items-center shrink-0">
            <Link href="/contact">
              <PoshButton className="shadow-lg h-11 px-6 text-[11px] font-black uppercase tracking-widest hover:bg-brand-ye bg-brand-red text-white hover:shadow-red-500/20 active:scale-95">
                Get Quote
              </PoshButton>
            </Link>
          </div>
