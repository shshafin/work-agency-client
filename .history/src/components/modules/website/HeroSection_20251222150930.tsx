    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-brand-dark">
      ...
      <SectionWrapper className="relative z-10 w-full pt-32 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* --- RIGHT: VISUAL (Fixed Red Layer Issue) --- */}
          <motion.div
            ...
            <div className="relative w-[400px] h-[400px]">
              {/* 1. THE RED BACK LAYER (The "Red Part") 
                   - Rotated and Offset so it is VISIBLE behind the logo 
                   - Floating with a slightly different rhythm for 3D effect
               */}
              <motion.div
                animate={{
                  y: [0, -20, 0],
                  rotate: [6, 10, 6], // Gentle rotation to keep it visible
                }}
                transition={{
                  duration: 8,
                  repeat: Infinity,
                ...
                className="absolute inset-0 bg-gradient-to-br from-brand-red to-red-900 rounded-3xl shadow-2xl z-0 transform translate-x-8 translate-y-8"
              />

              {/* 2. THE GLASS FRONT LAYER (The Logo) 
                   - Sits ON TOP of the red layer
               */}
              <motion.div
                animate={{ y: [0, -30, 0] }}
                transition={{
                ...
                className="absolute inset-0 z-10 bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-3xl shadow-2xl flex flex-col items-center justify-center">
              ...
              <motion.div
                ...
                className="absolute -top-6 -right-6 z-20 bg-brand-yellow text-brand-dark p-4 rounded-xl shadow-lg border border-white/50">
                <Award className="h-8 w-8 mb-1 text-brand-red" />
