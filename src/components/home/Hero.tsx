    ...
    <section className="relative min-h-[85vh] flex items-center pt-16 md:pt-20 pb-12 overflow-hidden bg-[#F8FAFC]">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute -top-[5%] -left-[5%] w-100 h-100 bg-brand-yellow rounded-full blur-[100px]"
        />
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-brand-blue leading-none tracking-tighter">
              Mastering <br />
              The Art Of <br />
          ...
          <div className="grid grid-cols-1 gap-5">
            <motion.div
              ...
              <div className="flex items-center gap-4 md:gap-6">
                ...
                <div className="text-left">
                  <h3 className="text-xl md:text-2xl text-brand-blue italic underline decoration-brand-yellow">
                    I want to Work
                  </h3>
            ...
            <motion.div
              ...
              <div className="flex items-center gap-4 md:gap-6">
                ...
                <div className="text-left">
                  <h3 className="text-xl md:text-2xl text-white italic underline decoration-brand-yellow">
                    I want to Hire
                  </h3>
