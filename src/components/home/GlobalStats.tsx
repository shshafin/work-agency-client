      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-7/12 relative mt-8 lg:mt-0">
            ...
            <div className="absolute left-5.75 lg:left-1/2 top-0 w-px h-full bg-linear-to-b from-transparent via-brand-blue/20 to-transparent" />

            {/* Moving Glow Dot */}
            <motion.div
              animate={{ top: ["0%", "100%"] }}
              transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
              className="absolute left-5 lg:left-[calc(50%-3px)] w-1.5 h-16 bg-linear-to-b from-brand-yellow to-transparent z-20 blur-[2px]"
            />
              ...
              {stats.map((stat, index) => (
                <div
                  ...
                  <div className="absolute left-0 lg:left-1/2 lg:-translate-x-1/2 z-30">
                    <div
                      className="w-12 h-12 flex items-center justify-center rounded-xl bg-white shadow-md border"
                      style={{
