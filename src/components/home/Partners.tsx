  ...
  return (
    <section className="py-24 bg-brand-light relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-px bg-linear-to-r from-transparent via-brand-blue/10 to-transparent" />
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-px bg-linear-to-r from-transparent via-brand-blue/10 to-transparent" />
      </div>
      ...
      <div className="relative group">
        ...
        <div className="absolute inset-y-0 left-0 w-24 md:w-64 bg-linear-to-r from-brand-light to-transparent z-10 pointer-events-none" />
        <div className="absolute inset-y-0 right-0 w-24 md:w-64 bg-linear-to-l from-brand-light to-transparent z-10 pointer-events-none" />
      ...
      <div className="container mx-auto px-6 mt-16">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 border-t border-brand-blue/5 pt-8">
          <div className="flex items-center gap-4">
            ...
            <p className="text-xs md:text-sm font-bold text-slate-400 max-w-62.5 leading-snug">
